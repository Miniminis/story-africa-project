  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a id="travel" class="nav-link" href="<c:url value='/'/>">여행<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<c:url value='/'/>">이벤트/축제</a>
      </li>
      <li class="nav-item">
        <a id="editorlist" class="nav-link" href="<c:url value='/member/memberlist'/>">에디터 탐색</a>
      </li>
      <li class="nav-item">
